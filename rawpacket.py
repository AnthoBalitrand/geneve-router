...
class RawPacket:
    def __init__(self, logger, raw_geneve_packet):
        ...
        if self.inner_ipv4.protocol == 17:
            ...
            logger.debug(f"Inner packet info : UDP src_port : {self.inner_udp.src_port} / dst_port : {self.inner_udp.dst_port}")
            ...
            logger.debug(f"Inner packet info : TCP src_port : {self.inner_tcp.src_port} / dst_port : {self.inner_tcp.dst_port} / flags : {self.inner_tcp.tcp_flags_str}")