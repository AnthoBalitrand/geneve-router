...
class RawPacket:
    def __init__(self, logger, raw_geneve_packet, flow_tracker):
        ...
        self.outter_udp = udp.UDP(self, self.outter_ipv4.header_end_byte + 1)
        ...
        self.inner_ipv4 = ipv4.IPv4(self, self.geneve.header_end_byte + 1)
        ...
        if self.inner_ipv4.protocol == 17:
            self.inner_l4 = udp.UDP(self, self.inner_ipv4.header_end_byte + 1, self.inner_ipv4.payload_length)
            ...
            self.inner_l4 = tcp.TCP(self, self.inner_ipv4.header_end_byte + 1, self.inner_ipv4.payload_length)
            ...
            self.inner_l4 = icmp.ICMP(self, self.inner_ipv4.header_end_byte + 1, self.inner_ipv4.payload_length)
